...
public class ClienteDirectoGUI extends JFrame {

    private JTextArea logArea;
    private JLabel estadoLabel, titulo, intentosLabel;
...
public ClienteDirectoGUI() {        setTitle("Cliente TCP - Panel");
        setSize(750, 480);
        ...
        titulo = new JLabel("CLIENTE TCP - CONEXION", JLabel.CENTER);
        ...
        panelEstado.setBackground(panelColor);
        ...
        panelEnviar.setBackground(panelColor);
    ...
    private void conectar() {
        ...
        while (true) {
            ...
            try {
                log("Intentando conectar con el servidor...");
                socket = new Socket(Config.HOST, Config.PORT); // <-- corregido
                ...
                new Thread(() -> {
                    try {
                        ...
                        throw new IOException("Servidor cerro");
                    } catch (IOException e) {
                        if (conectado) {
                            log("Conexion perdida. Reintentando...");
                        }
                        cerrarConexion();
                    }
                }).start();
                ...
                // Reinicia contador cada 5 intentos (igual que tu codigo original)
                if (intentos >= 5) {
                    log("Reiniciando contador...");
                    intentos = 0;
                }
    ...
    SwingUtilities.invokeLater(() -> new ClienteDirectoGUI().setVisible(true));
}
}